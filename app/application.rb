...
class Application
  ...
  (0...c).each do |i|
    ...
    page.driver.browser.url_blacklist = ['https://www.googleadservices.com/', 'https://assets.adobedtm.com', 'googleads.g.doubleclick.net', 'https://www.enterprise.com/etc/designs/ecom/dist/fonts/', 'https://cdnssl.clicktale.net', 'https://static.ads-twitter.com', 'https://developers.google.com', 'https://maps.googleapis.com', 'https://www.googleadservices.com']
